...
| ---- | ----- | ------ | ---------- |
| Пользователь | `user@formanima.dev` | `user123` | 5 целей, 40 дней прогресса (уровень 7, ранг journeyman, 7/12 ачивок), транзакции, бюджеты, накопления, дневник питания |
| Администратор | `admin@formanima.dev` | `admin123` | доступ к админ-панели `/admin` + базовые данные |
