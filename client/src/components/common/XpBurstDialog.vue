<template>
  <UiDialog v-model="visible" max-width="sm">
    <div class="p-6 text-center" style="border: 2px solid #e2532b; border-radius: 1rem; box-shadow: 0 0 30px rgba(226,83,43,0.3);">
      <div class="text-4xl mb-3">⚒️ ✨</div>
      <h3 class="text-lg font-bold mb-1">Выполнено!</h3>
      <p class="text-3xl font-bold mb-1" style="color: #e2532b;">+10 XP</p>
      <p v-if="totalStrikes >= 2" class="text-sm mb-4" style="color: rgba(168,153,124,0.82);">
        Streak: {{ totalStrikes }} дней 🔥
      </p>
      <div v-else class="mb-4" />
      <UiProgress :model-value="xpPercent" height="sm" class="mb-2" />
      <p class="text-xs" style="color: rgba(168,153,124,0.82);">
